...
!(function (t, e) {
  ...
  function $(t, e) {
    for (
      var r = t.length, n = 2 <= arguments.length ? e : void 0, o = [], a = 0;
      a < r;
      a++
    )
      if (a in t) {
  ...
  function m(t, e) {
    return F.dom(t) && i(k, e)
      ? "transform"
      : F.dom(t) && (t.getAttribute(e) || (F.svg(t) && t[e]))
      ? "attribute"
      : F.dom(t) && "transform" !== e && x(t, e)
      ? "css"
      : null != t[e]
      ? "object"
      : void 0;
    ...
    switch (m(t, e)) {
      case "transform":
        return (function (t, r) {
          var e,
            n =
              -1 < (e = r).indexOf("translate") || "perspective" === e
                ? "px"
  ...
  function w(e, r) {
    function t(t) {
      return (
        (t = void 0 === t ? 0 : t),
        e.el.getPointAtLength(1 <= r + t ? r + t : 0)
      );
    }
    var n = t(),
      o = t(-1),
  ...
  function j(t, r) {
    ...
    if (F.arr(t)) {
      var n = t.length;
      2 !== n || F.obj(t[0])
        ? F.fnc(r.duration) || (e.duration = r.duration / n)
        : (t = {
            value: t,
          });
    }
  ...
  function A(a, i) {
    ...
    return a.tweens.map(function (t) {
      ...
      return (
        ...
        (t.isPath = F.pth(e)),
        (t.isColor = F.col(t.from.original)),
        t.isColor && (t.round = 1),
        (u = t)
      );
    });
  ...
  function M(t) {
    ...
    function p(e) {
      for (var t = 0, r = {}, n = j.animations, o = n.length; t < o; ) {
        ...
        for (
          var s =
              ...
              u.duration,
            c = isNaN(s) ? 1 : u.easing(s, u.elasticity),
            f = ((s = u.to.strings), u.round),
            l = [],
            p = void 0,
            d = ((p = u.to.numbers.length), 0);
          d < p;
          d++
        ) {
          var m = void 0,
      ...
      if ((t = Object.keys(r).length))
        for (n = 0; n < t; n++)
          S ||
            (S = x(document.body, "transform")
              ? "transform"
              : "-webkit-transform"),
            (j.animatables[n].target.style[S] = r[n].join(" "));
    ...
    function e(t) {
      ...
      if (j.children.length) {
        var u = j.children,
          s = u.length;
        if (i >= j.currentTime) for (var c = 0; c < s; c++) u[c].seek(i);
        else for (; s--; ) u[s].seek(i);
      }
      (n <= i || !e) && (j.began || ((j.began = !0), d("begin")), d("run")),
        r < i && i < e
          ? p(i)
          : (i <= r && 0 !== o && (p(0), a && m()),
            ((e <= i && o !== e) || !e) && (p(e), a || m())),
        ...
        e <= t &&
          (j.remaining
            ? ((y = g),
              "alternate" === j.direction && (j.reversed = !j.reversed))
            : (j.pause(),
              j.completed ||
                ((j.completed = !0),
                d("complete"),
                "Promise" in window && (v(), (b = f())))),
          (h = 0));
    }
    t = void 0 === t ? {} : t;
    var g,
      ...
      (j.reset = function () {
        ...
        for (
          j.currentTime = 0,
            ...
            j.began = !1,
            j.completed = !1,
            j.reversed = "reverse" === t,
            j.remaining = "alternate" === t && 1 === e ? 2 : e,
            p(0),
            t = j.children.length;
          t--;
    ...
    L = (function () {
      ...
      return function (i, u, s, c) {
        if (0 <= i && i <= 1 && 0 <= s && s <= 1) {
          ...
          if (i !== u || s !== c)
            for (var t = 0; t < 11; ++t) f[t] = l(0.1 * t, i, s);
          return function (t) {
            if (i === u && s === c) return t;
            if (0 === t) return 0;
            if (1 === t) return 1;
            for (var e = 0, r = 1; 10 !== r && f[r] <= t; ++r) e += 0.1;
            r = e + ((t - f[--r]) / (f[r + 1] - f[r])) * 0.1;
            var n =
              3 * (1 - 3 * s + 3 * i) * r * r + 2 * (3 * s - 6 * i) * r + 3 * i;
            if (0.001 <= n) {
              for (
                e = 0;
                e < 4 &&
      ...
      var t,
        ...
        e = {
          ...
          InOut: [
            ...
            function (t, e) {
              return t < 0.5 ? r(2 * t, e) / 2 : 1 - r(-2 * t + 2, e) / 2;
            },
          ],
        },
        o = {
          linear: L(0.25, 0.25, 0.75, 0.75),
        },
        a = {};
      for (t in e)
        (a.type = t),
          e[a.type].forEach(
            (function (r) {
              return function (t, e) {
                o["ease" + r.type + n[e]] = F.fnc(t)
                  ? t
                  : L.apply($jscomp$this, t);
              };
            })(a)
          ),
          (a = {
...
function Navbar(t, n) {
  return (
    ...
    (this.node = this.qSelect(t)),
    ((this.node.navbar = this).uId = this.node.id),
    (this.inner = this.node.querySelector(".navbar-inner")),
    (this.wPos = null),
    (this.state = null),
    ...
    (this.iParams = Navbar.merge([this.mParams, this.defaults, n])),
    (this.dParams = Navbar.merge([this.iParams], {
      except: ["responsive"],
    })),
    this.iParams.responsive
      ? this.initResponsiveness()
      : (this.iParams.layout && this.updLayout(this.iParams.layout),
        this.iParams.stuck && this.initStuck(),
        this.iParams.anchor && this.initAnchor()),
    this
  );
}
(Navbar.prototype.qSelect = function (t) {
  ...
  (Navbar.map = function (t, e) {
    ...
    for (var n = {}, s = 0; s < t.length; s++) {
      ...
      if (a)
        for (var i in a)
          (e.except && !e.except.indexOf(i)) ||
            (!(a[i] instanceof Object) ||
            a[i] instanceof Node ||
            a[i] instanceof Function
              ? n[i] instanceof Object || (n[i] = null)
              : (n[i] = Navbar.map([n[i], a[i]], e)));
    }
    return n;
  }),
    ...
    for (var s in ((n = n || []), t)) {
      ...
      e(s, t[s], a),
        t[s] instanceof Object &&
          !(t[s] instanceof Node) &&
          Navbar.enumObj(t[s], e, a);
    }
  }),
  (Navbar.prototype.initResponsiveness = function () {
    (this.handlers.resizeHandler = this.resizeHandler.bind(this)),
      (this.handlers.mchangeHandler = this.mchangeHandler.bind(this)),
      this.handlers.resizeHandler(),
      this.handlers.mchangeHandler(),
      window.addEventListener("resize", this.handlers.resizeHandler),
      this.node.addEventListener("mediachange", this.handlers.mchangeHandler);
  }),
  (Navbar.prototype.updLayout = function (t) {
    this.layout && this.node.classList.remove(this.layout),
      (this.layout = t),
      this.layout && this.node.classList.add(this.layout);
  }),
  (Navbar.prototype.mchangeHandler = function () {
    this.updParams(),
      this.updLayout(this.dParams.layout),
      this.finStuck(),
      this.dParams.stuck && this.initStuck(),
      this.finAnchor(),
      this.dParams.anchor && this.initAnchor();
  }),
  ...
  (Navbar.prototype.paramSelect = function (t) {
    for (
      var e = Object.keys(this.iParams.responsive),
        n = e.indexOf(this.currentMedia);
      0 <= n;
      n--
    ) {
      if (
        (s = Navbar.follow(this.iParams.responsive[e[n]], t)) instanceof Object
      )
        return;
  ...
  (Navbar.prototype.resizeHandler = function () {
    ...
    for (var e in ((this.currentMedia = null), this.iParams.responsive))
      window.matchMedia("(min-width: " + e + "px)").matches &&
        (this.currentMedia = e);
    this.currentMedia !== t &&
      this.node.dispatchEvent(new CustomEvent("mediachange"));
  }),
  (Navbar.prototype.initStuck = function () {
    (this.stuckContainer = document.querySelector(
      this.dParams.stuck.container
    )),
      (this.handlers.wPosHandler = this.wPosHandler.bind(this)),
      (this.handlers.stateHandler = this.stateHandler.bind(this)),
      this.handlers.wPosHandler(),
      this.handlers.stateHandler(),
      window.addEventListener("scroll", this.handlers.wPosHandler),
      window.addEventListener("resize", this.handlers.wPosHandler),
      this.node.addEventListener("statechange", this.handlers.stateHandler);
  }),
  (Navbar.prototype.finStuck = function () {
    window.removeEventListener("scroll", this.handlers.wPosHandler),
      window.removeEventListener("resize", this.handlers.wPosHandler),
      this.node.removeEventListener("statechange", this.handlers.stateHandler);
  }),
  (Navbar.prototype.wPosHandler = function () {
    ...
    switch (
      (e.top >= this.dParams.stuck.offset
        ? (this.wPos = "above-container")
        : n.top >= this.dParams.stuck.offset
        ? (this.wPos = "above-wrapper")
        : n.bottom >= this.dParams.stuck.offset
        ? (this.wPos = "in-wrapper")
        : e.bottom >= this.dParams.stuck.offset + s.height
        ? (this.wPos = "under-wrapper")
        : e.bottom >= this.dParams.stuck.offset
        ? (this.wPos = "near-container-bottom")
        : (this.wPos = "under-container"),
      this.wPos)
    ) {
      case "in-wrapper":
      case "under-wrapper":
  ...
  (Navbar.prototype.stateHandler = function () {
    switch (this.state) {
      ...
      case "stuck":
        ...
        break;
      default:
        this.node.classList.remove("stick"),
          this.node.classList.remove("stuck");
    }
  }),
  (Navbar.prototype.initAnchor = function () {
    if (
      ((this.links = this.qSelect(this.dParams.anchor.list)), this.links.length)
    ) {
      for (var t = 0; t < this.links.length; t++) {
        var e = this.links[t];
        (e.anchor = document.querySelector(e.getAttribute("href"))),
          e.anchor &&
            ((e.ref = this),
            (e.anchClickHandler = Navbar.prototype.anchClickHandler),
            e.addEventListener("click", e.anchClickHandler));
      }
      (this.handlers.anchPosHandler = this.anchPosHandler.bind(this)),
        (this.handlers.anchangeHandler = this.anchangeHandler.bind(this)),
        this.handlers.anchPosHandler(),
        this.handlers.anchangeHandler(),
        window.addEventListener("scroll", this.handlers.anchPosHandler),
        window.addEventListener("resize", this.handlers.anchPosHandler),
  ...
  (Navbar.prototype.finAnchor = function () {
    ...
    window.removeEventListener("scroll", this.handlers.anchPosHandler),
      window.removeEventListener("resize", this.handlers.anchPosHandler),
  ...
  (Navbar.prototype.anchPosHandler = function () {
    ...
    for (var e = 0; e < this.links.length; e++) {
      var n = this.links[e];
      n.anchor &&
        Navbar.isUnderTop(n.anchor, this.dParams.anchor.offset) &&
        (this.currentAnchor = n);
    }
    t !== this.currentAnchor &&
      this.node.dispatchEvent(new CustomEvent("anchorchange"));
  }),
    ...
    function JScrollPane(elem, s) {
      ...
      function initialise(s) {
        ...
        if (pane === undefined) {
          ...
          hasContainingSpaceChanged =
            newPaneWidth !== paneWidth || newPaneHeight !== paneHeight;
