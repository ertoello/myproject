    ...
    $(function () {
        ...
        for (var z = 0; z < targets.length; z++) {
            var hiddenElements = targets[z].querySelectorAll(
                '[aria-hidden="true"]'
            ),
            visibleElements = targets[z].querySelectorAll(
                '[aria-hidden="false"]'
            );
        ...
        for (var i = 0; i < plugins.multitoggles.length; i++) {
            ...
            toggle = new Toggle({
                ...
                node.getAttribute("data-multitoggle")
                ),
                scope: document.querySelectorAll(node.getAttribute("data-scope")),
                isolate: document.querySelectorAll(
                node.getAttribute("data-isolate")
                ),
            });
        ...
        for (var i = 0; i < plugins.animePresets.length; i++) {
            ...
            applyAnimation(
            plugins.animePresets[i],
            presets(plugins.animePresets[i])[preset]
            );
        }
        }
